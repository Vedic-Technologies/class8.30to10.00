          ...
          <div className="pl-20 md:pl-40 pb-[400px] md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
            <h1 className="text-[30px] xl:text-[50px] text-white font-semibold">
              ...
              <div className="text-transparent bg-clip-text bg-gradient-to-r from-green-100 to-red-500">
                ...
                <br /> With Vedic Technologies
              </div>
            </h1>
            <p className="text-gray-200 hidden md:block">
              Embrace the AI era by continuously learning and adapting—it's your
              gateway to innovation and success. Cultivate your creativity and
              problem-solving skills, for they are irreplaceable by machines.
              Stay ahead by integrating ethical AI practices, ensuring a future
              where technology serves humanity responsibly.
            </p>
